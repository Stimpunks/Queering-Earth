...
CabinetA seventh gate, ported because a design was refused for want of it — and the gate now catches the design that was refused
...
**The gap is paper, and here that is a live one rather than an inherited one.** Star Stuff hands print collisions to a paper gate; this repository has none, and paper is the medium this house has already been burned by — forty-four of forty-six pages once printed blank. No print collision has been seen here, which is the only reason it is not in this port and the reason it is the obvious next thing.
