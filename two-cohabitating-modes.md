...
The third author is Wenn Lawson, and the journal’s byline is not The 2005 paper is *Attention, monotropism and the diagnostic criteria for autism*, *Autism* 9(2), 139–156, [doi:10.1177/1362361305051398](https://doi.org/10.1177/1362361305051398). **The paper itself has not been read here and nothing is quoted from it.** Its byline reads “Wendy Lawson”; he is a trans man who has published as Wenn for years, and Crossref, the journal record and most citation managers still carry the 1999-era name, so a citation generated automatically deadnames him. **A publisher’s record outranking a living author’s own name is not neutral accuracy.** We cite him as Wenn Lawson and state what the byline says, so the paper stays findable without that cost. [Helen Edgar](https://autisticrealms.com/) does this correctly and is where we saw it done.
