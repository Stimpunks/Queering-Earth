...
const CANDIDATES = [
  ...
  { id: 'redaction-inclusive', family: 'Redaction Inclusive', fmt: 'woff2',
    url: `${GL}/redaction-inclusive/-/raw/main/fonts/webfonts/Redaction-Inclusive-Regular.woff2`,
    licenceUrl: `${GL}/redaction-inclusive/-/raw/main/OFL.txt`,
  ...
  { id: 'unormative-fraktur', family: 'Unormative Fraktur', fmt: 'opentype',
    url: `${GL}/unormative-fraktur/-/raw/main/otf/UnormativeFraktur.otf`,
    licenceUrl: `${GL}/unormative-fraktur/-/raw/main/OFL.txt`,
  ...
  { id: 'enby-gertrude', family: 'Enby Gertrude', fmt: 'opentype',
    url: `${GL}/enby-gertrude/-/raw/main/otf/Enby_Gertrude_roman.otf`,
    licenceUrl: `${GL}/enby-gertrude/-/raw/main/README.md`,
  ...
  { id: 'insolente', family: 'Insolente', fmt: 'opentype',
    url: `${GL}/insolente/-/raw/main/otf/Insolente-Regular.otf`,
    licenceUrl: `${GL}/insolente/-/raw/main/README.md`,
    by: 'Bye Bye Binary', licence: 'stated in the README, no separate licence file upstream',
  ...
  { id: 'love', family: 'BBB Love', fmt: 'opentype',
    url: `${GL}/bbb-love-and-rage/-/raw/main/otf/BBBLove%26Rage-LOVE.otf`,
    licenceUrl: `${GL}/bbb-love-and-rage/-/raw/main/LICENSE_CUTE.md`,
  ...
  { id: 'rage', family: 'BBB Rage', fmt: 'opentype',
    url: `${GL}/bbb-love-and-rage/-/raw/main/otf/BBBLove%26Rage-RAGE.otf`,
    licenceUrl: `${GL}/bbb-love-and-rage/-/raw/main/LICENSE_CUTE.md`,
    by: 'Bye Bye Binary', licence: 'LICENSE_CUTE', role: 'display', kind: 'attitude',
...
for (const c of CANDIDATES) {
  ...
  if (c.licenceUrl) {
    licenceFile = `fonts/${c.id}-LICENCE.txt`;
...
await writeFile(join(OUT, 'candidates.json'), JSON.stringify(rows, null, 2) + '\n');
console.log(`\n  ${rows.length} candidate(s) · ${(rows.reduce((n, r) => n + r.bytes, 0) / 1048576).toFixed(2)} MB`);
/* ── the page ──────────────────────────────────────────────────────────────────
...
<title>Font specimen &mdash; a scratch page for Queering Earth</title>
...
<main class="spec-intro">
  <h1 style="font-family:'Newsreader',Georgia,serif">Font specimen</h1>
  <p style="font-family:'Newsreader',Georgia,serif;font-size:1.19rem;line-height:1.65">
    Candidates for a font picker, set in this site&rsquo;s own palette at its own sizes, on its
    own paper. Each block overrides only <code>--qe-display</code> and <code>--qe-body</code>,
    which is exactly what a picker would do &mdash; so what you see here is what you would get.
    Toggle the ground; body text is 1.19rem at 1.65, the same as a sheet.
  </p>
...
console.log('  wrote specimen/index.html and specimen/candidates.json');
console.log('  view it at /specimen/ — and delete the folder once the choice is made');
