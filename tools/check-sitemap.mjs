 ...
 *
 *   - `the-nearest-body-zine.html` had **never been listed**. A live
 ...
 *
 * 4. OFF-SITE OR NON-HTTPS `loc` — anything not under `https://queering.earth/`.
 ...
 *
 * 6. THE ROOT ENTRY — `https://queering.earth/` must be present, because
