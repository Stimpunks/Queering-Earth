...
**Settled for now: the page carries no drawn masthead, and the two Bewick plates carry the
animals instead** — which is what a mounted specimen is for, and they are better at it than
anything drawn here would be. **Open:** whether a masthead in outline — single closed contours,
thin ink stroke, no fills, animals drawn as line rather than as mass — would sit in the house
register. That is a real drawing job and worth doing deliberately, not in the tail of an
accession. The tray mark stays exactly as it is; nothing above changes it.
