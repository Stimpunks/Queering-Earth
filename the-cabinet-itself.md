...
Seven pages that are not specimens. How the cabinet is made, what it has recorded, how to look through it, and what it knows about you — which is very nearly nothing.
...
## Why these seven are one drawer

Because they are all answers to the same question: **how do you know any of this is true?** The rules are published so you can see what we hold ourselves to. The register is published so you can see where we failed it. The ledger is published so you can go and check a quotation against the thing it came from, and the quoting policy so you can see on what basis we took it. The decisions are published so you can see what was refused and why. The finding aid is how you reach any of it, and the privacy page is the accounting for what that reaching costs.
